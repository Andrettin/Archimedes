...
public:
	...
	explicit data_type_metadata(const std::string &class_identifier, const std::set<std::string> &database_dependencies, const std::set<std::string> &history_database_dependencies, const parsing_function_type &parsing_function, const std::function<void(bool)> &processing_function, const std::function<void()> &initialization_function, const std::function<void()> &text_processing_function, const std::function<void()> &checking_function, const std::function<void()> &clearing_function, const std::function<void(const QDateTime &, const timeline *, const QObject *)> &history_loading_function)
	...
	const std::function<void(const QDateTime &, const timeline *, const QObject *)> &get_history_loading_function() const
	{
...
private:
	...
	std::function<void(const QDateTime &, const timeline *, const QObject *)> history_loading_function;
};
